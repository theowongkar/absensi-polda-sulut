            ...
            <table class="min-w-full text-sm">
                <thead class="bg-[#ffdd19]">
                    <tr>
                        ...
                        <th class="p-2 font-normal text-left border-r border-yellow-400">NIP</th>
                        <th class="p-2 font-normal text-left border-r border-yellow-400">Nama</th>
                        <th class="p-2 font-normal text-left border-r border-yellow-400">Jenis Kelamin</th>
                        <th class="p-2 font-normal text-left border-r border-yellow-400">Jabatan</th>
                        <th class="p-2 font-normal text-center border-r border-yellow-400">Status</th>
                        <th class="p-2 font-normal text-center border-r border-yellow-400">Dibuat</th>
                ...
                <tbody class="divide-y divide-gray-300">
                    @forelse($employees as $employee)
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="p-2 border-r border-gray-300 whitespace-nowrap">{{ $employee->nrp }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="p-4 text-center text-gray-500">Tidak ada data karyawan</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
